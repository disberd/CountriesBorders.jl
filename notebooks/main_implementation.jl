...
# ╔═╡ 3a5dc7aa-e404-11ed-12c4-95bedc14ccc3
begin
	using GeoTables
	using Meshes
	using GeoInterface
...
# ╔═╡ 47cdbd38-e333-4d77-8749-ed43fc26c922
# ╠═╡ skip_as_script = true
#=╠═╡
begin
	using PlutoExtras
	using BenchmarkTools
	import PlutoPlotly: plot
end
  ╠═╡ =#

# ╔═╡ c0f9d525-c943-4b59-8603-96519a4072e5
md"""
# Packages
"""

# ╔═╡ fe2db007-55a8-4e45-a4f5-eea89dcd2c7d
#=╠═╡
ExtendedTableOfContents()
  ╠═╡ =#

# ╔═╡ 9bd84631-167f-47d3-89d5-ac67f3a5c97b
md"""
# Exports
"""
...
begin
"""
	extract_countries([shapetable::Shapefile.Table = CountriesBorders.SHAPETABLE]; kwargs...)
...
For a list of possible column names, check the variable `CountriesBorders.COLUMNN_NAMES`.
...
# ╠═╡ skip_as_script = true
#=╠═╡
asia = extract_countries(;continent = "Asia")
  ╠═╡ =#
...
git-tree-sha1 = "11038b1d8e25d33e1dd87361a6c6c993060be92e"
...
git-tree-sha1 = "c58545a687e3e35a3df69620e3f79c2ca8e9e780"
uuid = "61d90e0f-e114-555e-ac52-39dfb47a3ef9"
version = "0.7.0"

[[deps.GeoTables]]
deps = ["ArchGDAL", "GADM", "GeoInterface", "GeoJSON", "Meshes", "Shapefile", "Tables"]
git-tree-sha1 = "7ca346234af1496cc79d30167919bd4804dedbc5"
...
git-tree-sha1 = "71d73d474a452fdabb26c28b1d541b18ca258a48"
