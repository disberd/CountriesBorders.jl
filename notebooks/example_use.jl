...
begin
	rome = Point(LatLon(41.9, 12.49)) # Rome, Italy
	catania = Point(LatLon(37.5, 15.09)) # Catania, Sicily
	madrid = Point(LatLon(40.416, -3.703)) # Madrid, Spain
	paris = Point(LatLon(48.864, 2.349)) # Paris, France
end
...
git-tree-sha1 = "3bebe963dc664ec1f34f19e43e68575d96f449e1"
uuid = "b46f11dc-f210-4604-bfba-323c1ec968cb"
version = "0.10.9"

[[CountriesBorders]]
deps = ["Artifacts", "CoordRefSystems", "GeoInterface", "GeoJSON", "GeoTables", "Meshes", "NaturalEarth", "PrecompileTools", "Tables", "Unitful"]
git-tree-sha1 = "520d267658efc9cbde7c56c517f6ecc8e0377432"
repo-rev = "b1c8de056a1ad54688640bb6464ba7735163e8ee"
repo-url = "https://github.com/disberd/CountriesBorders.jl"
uuid = "ee40d4b5-31c3-4fe2-b6cc-5ac7adf7f414"
version = "0.4.0-DEV"
weakdeps = ["PlotlyBase"]

    [CountriesBorders.extensions]
...
[[DataScienceTraits]]
deps = ["Dates"]
git-tree-sha1 = "965ff3403f9c0b11e8376683e318276c458bbcc9"
uuid = "6cb2f572-2d2b-4ba6-bdb3-e710fa044d6c"
version = "0.4.1"

    [DataScienceTraits.extensions]
...
git-tree-sha1 = "bce464896ee77680afb12bd440037e5513eaed1c"
uuid = "e502b557-6362-48c1-8219-d30d308dcdb0"
version = "1.22.3"

    [GeoTables.extensions]
...
git-tree-sha1 = "f2add939631dc27759367c292f0c4b8d072a6306"
